"""
Task: Task 010 is to create a flappy bird game!
...
pygame.mixer.init()
try:
    flap_sound = pygame.mixer.Sound("010_flappy-bird/assets/flap.wav")
    score_sound = pygame.mixer.Sound("010_flappy-bird/assets/score.wav")
    crash_sound = pygame.mixer.Sound("010_flappy-bird/assets/crash.wav")
    select_sound = pygame.mixer.Sound("010_flappy-bird/assets/select.wav")
    
    # Background Music
    try:
        pygame.mixer.music.load("010_flappy-bird/assets/music.wav")
...
# Sprite setup
try:
    bird_img = pygame.image.load("010_flappy-bird/assets/bird.png").convert_alpha()
...
class Bird:
    def __init__(self):
        self.rect = pygame.Rect(50, SCREEN_HEIGHT // 2, BIRD_SIZE, BIRD_SIZE)
        self.velocity = 0
        self.angle = 0
...
class Cloud:
    def __init__(self):
        ...
        self.rect = pygame.Rect(SCREEN_WIDTH, random.randint(20, 200), self.width, self.height)
...
class Coin:
    def __init__(self):
        self.size = 20
        self.rect = pygame.Rect(SCREEN_WIDTH, random.randint(100, SCREEN_HEIGHT - 100), self.size, self.size)
        self.speed = PIPE_SPEED # Matches pipe speed for consistency
